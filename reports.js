...
try{$members=@(Invoke-ExoRest -Cmdlet Get-DistributionGroupMember -Parameters @{Identity=$grp.Guid;ResultSize='Unlimited'})}catch{[PSCustomObject]@{Result='ERROR';Error=$_.Exception.Message;Hint='Resolved the list but could not expand its members. If this is a dynamic distribution group it needs Get-DynamicDistributionGroupMember instead.'};return}
