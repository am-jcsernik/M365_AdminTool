Add my **personal** GitHub remote to this repo.

GitHub owner/org: `arcenik86`
...
1. Build the URL:
   - HTTPS: `https://github.com/arcenik86/<repo>.git`
   - SSH:   `git@github.com:arcenik86/<repo>.git`
2. Run `git remote get-url origin` to check whether `origin` already exists.
   - If `origin` is free, add it as `origin`.
   - If `origin` is taken, add it as `personal` instead and tell me which name you used.
